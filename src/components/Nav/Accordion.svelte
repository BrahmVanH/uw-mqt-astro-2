...
<Accordion
  {value}
  type="single"
  class="hidden lg:block w-full max-w-3xl mx-auto relative"
  onmouseleave={handleOnMouseLeave}
  role="menu"
>
  <AccordionItem
    value={link.title}
    class="group border-none flex-row transition-all duration-300lg:hover:shadow-[0_0_15px_rgba(0,68,181,0.05)]"
    role="none"
  >
    <AccordionTrigger
      class={`${styles.navTrigger} py-0 lg:hover:text-accent-foreground lg:hover:scale-105 lg:hover:transition-all  focus:text-accent-foreground`}
