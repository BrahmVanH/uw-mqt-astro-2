							...
							>
								...
								<div class="p-6">
									...
									<div class="flex flex-col justify-between items-center gap-2 mt-2">
										{#if item.linkText}
											<LearnMoreBtn size="md" text={item.linkText} href={item.link} color="white" ariaLabel={item.linkText} />
										{/if}
										{#if item.linkTextTwo}
											<LearnMoreBtn size="md" text={item.linkTextTwo} href={item.linkTwo} color="white" ariaLabel={item.linkTextTwo} />
										{/if}
									</div>
								</div>
							</div>
