...
const NavigationMenu: React.FC<React.ComponentProps<typeof NavigationMenuPrimitive.Root>> = ({ className, children, ...props }) => (
	<NavigationMenuPrimitive.Root className={cn('relative z-10 flex flex-1 items-center justify-center', className)} {...props}>
		{children}
...
const NavigationMenuList: React.FC<React.ComponentProps<typeof NavigationMenuPrimitive.List>> = ({ className, ...props }) => (
	<NavigationMenuPrimitive.List className={cn('group flex flex-1 list-none items-center justify-center space-x-1', className)} {...props} />
);
...
const NavigationMenuTrigger: React.FC<React.ComponentProps<typeof NavigationMenuPrimitive.Trigger>> = ({ className, children, ...props }) => (
	<NavigationMenuPrimitive.Trigger className={cn(navigationMenuTriggerStyle(), 'group', className)} {...props}>
		{children} <ChevronDown className='relative top-[1px] ml-1 h-2 w-2 xl:h-3 xl:w-3 transition duration-200 group-data-[state=open]:rotate-180' aria-hidden='true' />
...
const NavigationMenuViewport: React.FC<React.ComponentProps<typeof NavigationMenuPrimitive.Viewport>> = ({ className, ...props }) => (
	<div className={cn('absolute left-1/4 xl:left-[50%] top-full flex w-full ')}>
...
const NavigationMenuIndicator: React.FC<React.ComponentProps<typeof NavigationMenuPrimitive.Indicator>> = ({ className, ...props }) => (
