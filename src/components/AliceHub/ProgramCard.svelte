...
<div data-category={category} class="card-decal relative min-w-full min-h-[500px] xl:min-h-[350px] flex flex-col overflow-hidden rounded-lg [&>*]:mb-2 [&>*]:mx-2 [&>*]:z-10 {className}">
	<!-- Program header -->
	<div class="mt-2">
	...
	<div class="w-full h-full flex flex-col xl:flex-row">
			...
			<!-- Mobile: Top row with service areas and learn more button -->
			<!-- Desktop: Same row layout but with requirements in middle -->
			<div class="w-full flex flex-row xl:w-auto xl:flex-row">
					...
					<!-- Desktop only: Requirements in middle -->
			...
			<!-- Mobile only: Requirements section below (full width) -->
			{#if program.requirements.length > 0}
